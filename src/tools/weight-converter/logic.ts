...
/**
 * Weight Converter configuration. The units themselves live in `@/lib/units`, shared
 * with the other type converters and every pair page, so a corrected ratio
 * fixes all of them at once.
 */
export const categoryId: string = "weight";

export const defaultFrom = "kg";
export const defaultTo = "lb";
