...
const registry: Record<string, React.ComponentType> = {
  ...
  "json-to-typescript": lazyTool(() => import("@/tools/json-to-typescript/Tool")),
  "yaml-to-json": lazyTool(() => import("@/tools/yaml-to-json/Tool")),
  "sql-formatter": lazyTool(() => import("@/tools/sql-formatter/Tool")),
  "subnet-calculator": lazyTool(() => import("@/tools/subnet-calculator/Tool")),
  "cron-expression-builder": lazyTool(() => import("@/tools/cron-expression-builder/Tool")),
  "hmac-generator": lazyTool(() => import("@/tools/hmac-generator/Tool")),
  ...
  "angle-converter": lazyTool(() => import("@/tools/angle-converter/Tool")),
  "energy-converter": lazyTool(() => import("@/tools/energy-converter/Tool")),
  "power-converter": lazyTool(() => import("@/tools/power-converter/Tool")),
  ...
  "dilution-calculator": lazyTool(() => import("@/tools/dilution-calculator/Tool")),
  "gravitational-force-calculator": lazyTool(() => import("@/tools/gravitational-force-calculator/Tool")),
  "work-done-calculator": lazyTool(() => import("@/tools/work-done-calculator/Tool")),
  "projectile-motion-calculator": lazyTool(() => import("@/tools/projectile-motion-calculator/Tool")),
  "standard-deviation-calculator": lazyTool(() => import("@/tools/standard-deviation-calculator/Tool")),
  "decibel-calculator": lazyTool(() => import("@/tools/decibel-calculator/Tool")),
  "momentum-calculator": lazyTool(() => import("@/tools/momentum-calculator/Tool")),
  "ideal-gas-law-calculator": lazyTool(() => import("@/tools/ideal-gas-law-calculator/Tool")),
  "specific-heat-calculator": lazyTool(() => import("@/tools/specific-heat-calculator/Tool")),
  "hookes-law-calculator": lazyTool(() => import("@/tools/hookes-law-calculator/Tool")),
  "torque-calculator": lazyTool(() => import("@/tools/torque-calculator/Tool")),
  "resistor-network-calculator": lazyTool(() => import("@/tools/resistor-network-calculator/Tool")),
  "redact-image": lazyTool(() => import("@/tools/redact-image/Tool")),
  "dpi-calculator": lazyTool(() => import("@/tools/dpi-calculator/Tool")),
  "viewing-distance-calculator": lazyTool(() => import("@/tools/viewing-distance-calculator/Tool")),
  "clothing-size-converter": lazyTool(() => import("@/tools/clothing-size-converter/Tool")),
  "gpa-calculator": lazyTool(() => import("@/tools/gpa-calculator/Tool")),
  "due-date-calculator": lazyTool(() => import("@/tools/due-date-calculator/Tool")),
  "body-fat-calculator": lazyTool(() => import("@/tools/body-fat-calculator/Tool")),
  "json-diff": lazyTool(() => import("@/tools/json-diff/Tool")),
  "photo-collage": lazyTool(() => import("@/tools/photo-collage/Tool")),
  "circle-crop": lazyTool(() => import("@/tools/circle-crop/Tool")),
  "unicode-lookup": lazyTool(() => import("@/tools/unicode-lookup/Tool")),
  "roman-numeral-converter": lazyTool(() => import("@/tools/roman-numeral-converter/Tool")),
  "shoe-size-converter": lazyTool(() => import("@/tools/shoe-size-converter/Tool")),
  "dns-lookup": lazyTool(() => import("@/tools/dns-lookup/Tool")),
  "http-header-checker": lazyTool(() => import("@/tools/http-header-checker/Tool")),
  "what-is-my-ip": lazyTool(() => import("@/tools/what-is-my-ip/Tool")),
  "http-status-codes": lazyTool(() => import("@/tools/http-status-codes/Tool")),
  "cooking-time-calculator": lazyTool(() => import("@/tools/cooking-time-calculator/Tool")),
  "strip-html": lazyTool(() => import("@/tools/strip-html/Tool")),
